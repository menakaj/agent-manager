...
type GatewayListResponse struct {
	...
	Metadata *GatewayListResponseMetadata `json:"metadata,omitempty"`
}
...
func (o *GatewayListResponse) GetMetadata() GatewayListResponseMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret GatewayListResponseMetadata
		return ret
	}
	return *o.Metadata
}
...
// and a boolean to check if the value has been set.
func (o *GatewayListResponse) GetMetadataOk() (*GatewayListResponseMetadata, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *GatewayListResponse) HasMetadata() bool {
	if o != nil && !IsNil(o.Metadata) {
		return true
	}
...
// SetMetadata gets a reference to the given GatewayListResponseMetadata and assigns it to the Metadata field.
func (o *GatewayListResponse) SetMetadata(v GatewayListResponseMetadata) {
	o.Metadata = &v
}

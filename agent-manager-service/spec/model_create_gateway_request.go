...
type CreateGatewayRequest struct {
	...
	// Virtual host/domain for the gateway
	Vhost string `json:"vhost"`
	// Geographic region
	Region *string `json:"region,omitempty"`
	// List of environment UUIDs to associate with gateway
...
func NewCreateGatewayRequest(name string, displayName string, vhost string) *CreateGatewayRequest {

...
type GatewayResponse struct {
	// Gateway UUID from Platform API
	...
	// Environments associated with this gateway
...
func NewGatewayResponse(uuid string, name string, displayName string, vhost string, status string, createdAt time.Time, updatedAt time.Time) *GatewayResponse {
...
func (o *GatewayResponse) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GatewayResponse) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GatewayResponse) SetStatus(v string) {
	o.Status = v
}
...
func (o *GatewayResponse) GetEnvironments() []EnvironmentSummary {
...
// and a boolean to check if the value has been set.
func (o *GatewayResponse) GetEnvironmentsOk() ([]EnvironmentSummary, bool) {
	if o == nil || IsNil(o.Environments) {
		return nil, false
	}
...
// SetEnvironments gets a reference to the given []EnvironmentSummary and assigns it to the Environments field.
func (o *GatewayResponse) SetEnvironments(v []EnvironmentSummary) {
	o.Environments = v
}
